			...
			if(contact == null) { 
				...
				try {
					...
					if(serverSender != null) {
						...
						w.writeObject(new RepMIJoinMessage(receiverContact.identifier(), 
								      ibisRPI, receiver.identifier()));
						w.finish();
						...
						RepMIWelcomeMessage welcome = (RepMIWelcomeMessage)r.readObject();
						r.finish();						
						...
						System.out.println("size of sent queue " + welcome.oq.size());
						*/
