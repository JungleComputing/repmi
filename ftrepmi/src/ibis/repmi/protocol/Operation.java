...
public class Operation implements Serializable {
    ...
    public Operation(ProcessIdentifier id, Long ts, ReplicatedMethod meth,
            int opType) {
    ...
    public Operation(ProcessIdentifier id, ProcessIdentifier contactId,
            Long ts, int opType, ReceivePortIdentifier joinAckPortId,
