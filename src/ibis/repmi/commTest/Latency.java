...
class Latency {
	...
	public static void main(String[] args) {
		...
		try {
			...
			"OneToMany, Reliable, ExplicitReceipt");
			...
			Operation op = new Operation(new ProcessIdentifier(ibis.identifier()), 
										 new Long(0), new ReplicatedMethod("bla", new Class[]{Integer.class}, new Object[]{new Integer(10)}), 
										 remoteRank);
			...
			if (rank == 0) {
				...
				for (int j=0; j<size; j++) {                    
					...
					ltv.addEntry(new ProcessIdentifier(id.ibis()), new Long(0));
					sport.connect(id);
				}
